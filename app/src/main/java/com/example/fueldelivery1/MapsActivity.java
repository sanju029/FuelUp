...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Bitmap createUserBitmap() {
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.marker_image_new);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot f : dataSnapshot.getChildren()) {
                        ...
                        if(CalculationByDistance(currentLocation,storedLocation) == true) {
                            mMap.addMarker(new MarkerOptions().position(storedLocation).title(st.getName()).icon(BitmapDescriptorFactory.fromBitmap(bitmap))).setTag(st.getId());
